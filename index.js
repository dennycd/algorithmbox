...
//example SAT Problem
Example.SAT = require('./src/example/sat/Problem.js');
Example.GSAT = require('./src/example/sat/Algorithms.js').GSAT_IIA;
Example.SAT_SA = require('./src/example/sat/Algorithms.js').SAT_SA;
Example.SAT_TS = require('./src/example/sat/Algorithms.js').SAT_TS;

//example TSP Problem
Example.TSP = require('./src/example/tsp/Problem.js');
Example.TSP_Solution = require('./src/example/tsp/Solution.js');
Example.IIA = require('./src/example/tsp/Algorithms.js').TSP_IIA;
Example.SA = require('./src/example/tsp/Algorithms.js').TSP_SA;
Example.TS = require('./src/example/tsp/Algorithms.js').TSP_TS;
